...
vcf_files=(
    ...
    ${vcf_dir}/B73-Ki3.vcf
    ${vcf_dir}/B73-Ki3.vcf
    ${vcf_dir}/B73-Oh43.vcf
    ${vcf_dir}/B73-Oh43.vcf
    ${vcf_dir}/B73-Oh43.vcf
    ${vcf_dir}/B73-Oh43.vcf
    ${vcf_dir}/Ki3-Oh43.vcf
    ${vcf_dir}/Ki3-Oh43.vcf
    ${vcf_dir}/Ki3-Oh43.vcf
    ${vcf_dir}/Ki3-Oh43.vcf
)
...
mkdir -p 3_hybrid_genotyping_based_on_read_counts/1_read_count_file
count="3_hybrid_genotyping_based_on_read_counts/1_read_count_file/${prefix}_count.txt"
...
#================= get counts ==========================
python ./count_reads.py $bam_file $vcf_file $count
